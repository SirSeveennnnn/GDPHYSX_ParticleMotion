...
void Model::Draw(GLuint ShaderProgram, bool perspective, PerspectiveCamera perspectiveCamera, Light light)
{
...
void Model::Update(float deltaTime)
{
    ...
    if (onGravity)
    {
        Transform = glm::translate(Transform, glm::vec3(0, 0, -300 * deltaTime));
    }

    if (onForce)
    {
        xVelocity *= deltaTime * pow(dampingFactor, deltaTime);
        Transform = glm::translate(Transform, glm::vec3(xVelocity, 0, 0));
    }
}
